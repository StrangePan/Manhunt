...
public class CmdExec implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command c, String cmd,
		...
		// DataFile f = (Game.isGameStarted()) ?
		// Game.getActiveGame().getDataFile() : null;
		...
		if (args.length == 0 || args[0].equalsIgnoreCase("help")) {
			 ...
			 * settings.changeSetting("hunterLoadout",
			 * p.getInventory().getContents()); p.sendMessage(ChatColor.GREEN +
			 * "Loadout set");
			 */
