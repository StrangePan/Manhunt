...
public class LobbySettings extends SettingsPack
{
	...
	public final IntegerSetting		MIN_PLAYERS;
	...
	public LobbySettings()
	{
		...
		addSetting(MAX_PLAYERS =	new IntegerSetting("maxplayers", -1, "Maximum players allowed in lobby.", "No player cap."), true);
		addSetting(MIN_PLAYERS =	new IntegerSetting("minplayers", 2, "Minimum players to start game.", "Minimum players to start game."), true);
